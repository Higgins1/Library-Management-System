                ...
                <div class="row">
                    <div class="col-xs-12">
                        <!-- PAGE CONTENT BEGINS -->						<?php								$link=mysqli_connect("localhost","root","root","library");	
								$result = mysqli_query($link,"select * from user where iduser='$stu_id';");
								$row = mysqli_fetch_array($result,MYSQLI_NUM); 
								$afine = $row[4];
								echo'                           '.'您的罚款金额为'.$afine.'   ';						?>
   						 <div class="row">
                            <div class="col-xs-12">
										<form class="form-horizontal" role="form" action="../view/clear.php" method="post">
                               					<p>	</p>
           				
             					    	<div>
                    						   <div class="col-md-offset-3 col-md-9">
                               					<p>	</p>
                      							       <input type="submit" value="缴纳罚款" class="btn btn-info"/>
                   							    </div>
               						  	</div>
										</form>
                            </div>
