            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <h3 class="header smaller lighter blue">图书列表</h3>
                                <div class="table-header">
                                    图书列表
                                </div>

                                <div class="table-responsive">
                                    <table id="sample-table-2" class="table table-striped table-brecorded table-hover">
                                        <thead>
                                        <tr>
                                            <th class="center">
                                                <label>
                                            ...
                                            </th>                                            <th class="hidden-480 center">关键词</th>
                                            <th class="center">书籍编号</th>
                                            <th class="center">类型</th>
                                            <th class="hidden-480 center">在馆状态</th>
                                        ...
                                        foreach($allrows as $row){
                                            ...
                                            echo '</label>';
                                            echo '</td>';
                                            echo '<td class="center" id="idbook">'.$row['keyword'].'</td>';
                                            echo '<td class="center" id="idbook">'.$row['idbook'].'</td>';
                                            echo '<td class="hidden-480 center">'.$row['type'].'</td>';
                                            echo '<td class="center" id="idbook">'.$row['state'].'</td>';
