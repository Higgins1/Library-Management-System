            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
										<form class="form-horizontal" role="form" action="../view/borrowbook.php" method="post">
                               					<p>	</p>
           						     	 <div>
            					        	  <label class="col-sm-3 control-label no-padding-right" for="hotelName">书籍编号</label>

              						           <div class="col-sm-9">
                					             <input type="text" id="idbook" name="idbook" placeholder="书籍编号" class="col-xs-10 col-sm-5"/>
               						          </div>
               						 	 </div>
             					    	...
             					    	<div>
                    						   <div class="col-md-offset-3 col-md-9">
                               					<p>	</p>
                      							       <input type="submit" value="借阅" class="btn btn-info"/>
                   							    </div>
               						  	</div>
										</form>
                            </div>
                            ...
                            <div class="col-xs-12">
										<form class="form-horizontal" role="form" action="../view/reborrow.php" method="post">
                               					<p>	</p>
           						     	 <div>
            					        	  <label class="col-sm-3 control-label no-padding-right" for="hotelName">书籍编号</label>
             					    	...
             					    	<div>
                    						   <div class="col-md-offset-3 col-md-9">
                               					<p>	</p>
                      							       <input type="submit" value="续借" class="btn btn-info"/>
                   							    </div>
               						  	</div>
										</form>
                            </div>
