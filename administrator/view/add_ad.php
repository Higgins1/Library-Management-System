                ...
                <div class="row">
                    <div class="col-xs-12">
                        <!-- PAGE CONTENT BEGINS -->
  							<div class="row">
                            	<div class="col-xs-12">
										<form class="form-horizontal" role="form" action="../view/make_ad.php" method="post">
                               					<p>	</p>
           						     	 <div>
            					        	  <label class="col-sm-3 control-label no-padding-right" for="hotelName">管理员姓名</label>

              						           <div class="col-sm-9">
                					             <input type="text" id="name" name="name" placeholder="管理员姓名" class="col-xs-10 col-sm-5"/>
               						          </div>
               						 	 </div>	 										<div>
            					        	  <label class="col-sm-3 control-label no-padding-right" for="hotelName">管理员性别</label>

              						           <div class="col-sm-9">
                					             <input type="text" id="sex" name="sex" placeholder="管理员性别" class="col-xs-10 col-sm-5"/>
               						          </div>
               						 	 </div>
             					    	...
             					    	<div>
                    						   <div class="col-md-offset-3 col-md-9">
                               					<p>	</p>
                      							       <input type="submit" value="新增管理员" class="btn btn-info"/>
                   							    </div>
               						  	</div>
										</form>
    								</div>
							...
							<div class="row">
                       		     <div class="col-xs-12">										<form class="form-horizontal" role="form" action="../view/del_ad.php" method="post">
           						     	 <div>             									<p>	</p>
            					        	  <label class="col-sm-3 control-label no-padding-right" for="hotelName">管理员编号</label>

              						           <div class="col-sm-9">
                					             <input type="text" id="id" name="id" placeholder="管理员编号" class="col-xs-10 col-sm-5"/>
               						          </div>
               						 	 </div>
										...
										<div>
             					    	...
             					    	<div>
                    						   <div class="col-md-offset-3 col-md-9">
                               					<p>	</p>
                      							       <input type="submit" value="删除管理员" class="btn btn-info"/>
                   							    </div>
               						  	</div>
										</form>    								</div>
                        		</div>
