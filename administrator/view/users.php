                                ...
                                <div class="table-responsive">
                                    <table id="sample-table-2" class="table table-striped table-brecorded table-hover">
                                        ...
                                        <tr>
                                            ...
                                            <th class="hidden-480 center">借书数量</th>
                                            <th class="center">罚款金额</th>
                                        </tr>
                                        </thead>
                                        ...
                                        foreach($allrows as $row){
                                            ...
                                            echo '<td class="center" id="iduser">'.$row['iduser'].'</td>';
                                            echo '<td class="center" id="idbook">'.$row['sex'].'</td>';
                                            echo '<td class="center" id="idbook">'.$row['borrowed_book_num'].'</td>';
                                            echo '<td class=" hidden-480 center">'.$row['fine_amount'].'</td>';
                                            echo '<td class="center">';
