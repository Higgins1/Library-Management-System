                    ...
                    <div class="col-xs-12">
						...
						<?php
								...
								mysqli_set_charset($link,'utf8');
	  							$query = mysqli_query($link,"insert into user(iduser,name,sex,password,borrowed_book_num,fine_amount)										values(null,'$name_ad','$sex_ad','$psd',0,0);");
								if ($query)
								{	
									echo"新增用户成功！";
								}
