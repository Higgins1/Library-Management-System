                    ...
                    <div class="col-xs-12">
                        <!-- PAGE CONTENT BEGINS -->
  							<?php
								...
								$query1 = mysqli_query($link,"select * from administrator where idadministrator='$stu_id' and password='$old_';");
								$row1 = mysqli_num_rows($query1);
								if (!$row1){
									echo "旧密码不正确！";
								}
								else {
	  								$query = mysqli_query($link,"update administrator set password='$new_' where idadministrator='$stu_id';");
									if ($query)
									{	
										echo "修改密码成功！";
									}
