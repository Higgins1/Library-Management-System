            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <h3 class="header smaller lighter blue">借阅记录</h3>
                                ...
                                <div class="table-responsive">
                                    <table id="sample-table-2" class="table table-striped table-bordered table-hover">
                                        ...
                                        <tr>
                                            ...
                                            <th class="center">借阅编号</th>
                                            <th class="center">读者编号</th>
                                            <th class="center">书籍编号</th>
                                            <th class="center">关键词</th>
                                            <th class="hidden-480 center">借书日期</th>
                                            <th class="hidden-480 center">还书期限</th>
                                            <th class="center">归还日期</th>
                                        ...
                                        $allrows = $pdoMysql->find("borrowed_record");
                                        foreach($allrows as $row){
                                            ...
                                            echo '<td class="center" id="idrecord">'.$row['idrecord'].'</td>';
                                            echo '<td class="hidden-480 center">'.$row['iduser'].'</td>';
                                            echo '<td class="hidden-480 center">'.$row['idbook'].'</td>';
											$idbook=$row['idbook'];
                                            ...
                                            echo '<td class="hidden-480 center">'.$row['return_date'].'</td>';
